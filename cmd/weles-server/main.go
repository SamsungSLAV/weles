...
func main() {
	...
	flag.StringVar(&aritfactDatabase, "database", "/var/lib/weles/artifacts.db",
		"Absolute path to where *.db file is located (or should be created).")

	flag.StringVar(&artifactStorage, "storage", "/var/lib/weles/storage",
