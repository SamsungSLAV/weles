  ...
  "definitions": {
    ...
    "ArtifactFilter": {
      ...
      "properties": {
        ...
        "Type": {
          "description": "Refer to ArtifactType documentation for possible values. Useful for\nrequesting only RESULT artifacts from a Job.",
          "type": "array",
          "items": {
            "$ref": "#/definitions/ArtifactType"
          }
    ...
    "ArtifactSorter": {
      ...
      "properties": {
        "By": {
          "description": "Key by which Artifacts will be sorted. See ArtifactSortBy\ndocumentation.",
    ...
    "JobFilter": {
      ...
      "properties": {
        ...
        "Name": {
          "description": "Filter by name acquired Job Submission file (yaml format, job_name\nkey's value). Allows usage of regular expressions.",
          "type": "array",
          "items": {
            "type": "string"
          }
    ...
    "JobInfo": {
      ...
      "properties": {
        ...
        "info": {
          "description": "provides additional information about current state, e.g. cause of\nfailure",
          "type": "string"
        },
        "jobID": {
