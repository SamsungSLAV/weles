...
type ArtifactListerParams struct {
	...
	/*Fill this parameter with Artifact's ID (don't mix it with JobID) of the last element from current page to receive next one.
	...
	*/
	...
	/*Fill this parameter with Artifact's ID (don't mix it with JobID) of the first element from current page to receive previous one.
